...
public class weather_class extends AppCompatActivity implements ForecastAdapterOnClickHandler {
                ...
                public void onNavigationItemReselected(@NonNull MenuItem menuItem) {
                    ...
                    switch (menuItem.getItemId()){
                        case R.id.news:
                            ...
                            Intent intentToStartDetailActivity = new Intent(contexti, newsClass);
                        ...
                        case R.id.home_it:
                             intentToStartDetailActivity = new Intent(contexti, homeClass);
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                String[] simpleJsonWeatherData = OpenWeatherJsonUtils
                        .getSimpleWeatherStringsFromJson(weather_class.this, jsonWeatherResponse);
